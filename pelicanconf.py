...
LANDING_PAGE_ABOUT = {'title': 'Python and Deep Learning',
       ...
       <p>I mostly work in Python within OSX and Linux, but I have also occasionally dabbled in  languages like R and Scala. This blog will be primarily about using Python for deep learning, but I will likely delve into a wide variety of topics. It also will serve as a place for me to gather and organize my learning process as I begin working in this field. I want to do projects that are fun but challenge my skills as well. </p><p>Besides programming, I like to exercise, go to
       live concerts, tinker with my raspberry pi, drink craft beer, and play acoustic guitar.
       Fun fact, this website was generated by and being served from my raspberry pi, of course by using my favorite language, Python!
       </p></div>"""}
